                          ...
                          const Vector3f &dir, float &tnear, float &u, float &v)
{
    ...
    // [t, u, v] = 1 / (vs1.dot(e1)) * [s2.dot(e2), s1.dot(s), s2.dot(d)] in which u, v, t must > 0 and
    // e1 = v1 - v0;
    // e2 = v2 - v0;
    // s = o - v0;
    // s1 = d.cross(e2)
    ...
    Vector3f tb1b2 = 1 / (dotProduct(s1, e1)) * Vector3f(dotProduct(s2, e2), dotProduct(s1, s), dotProduct(s2, d));
    float t = tb1b2.x;
    float b1 = tb1b2.y;
    float b2 = tb1b2.z;
