...
void init(GLFWwindow* window) {
	renderingProgram = Utils::createShaderProgram("./OpenGLTemplate/src/Chapter5/Prog5_1_texturedPyramid/vertShader.glsl", "./OpenGLTemplate/src/Chapter5/Prog5_1_texturedPyramid/fragShader.glsl");
