...
void init(GLFWwindow* window) {
	renderingProgram = Utils::createShaderProgram("./OpenGLTemplate/src/Chapter5/Prog5_1b_texturedPyramidMipmapAniso/vertShader.glsl", "./OpenGLTemplate/src/Chapter5/Prog5_1b_texturedPyramidMipmapAniso/fragShader.glsl");
	...
	brickTexture = Utils::loadTexture("./OpenGLTemplate/Textures/brick1.jpg");
