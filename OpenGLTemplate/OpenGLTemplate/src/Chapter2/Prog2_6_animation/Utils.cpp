...
GLuint Utils::createShaderProgram() {
	...
	string vertShaderStr = readFile("./OpenGLTemplate/src/Chapter2/Prog2_6_animation/vertShader.glsl");
	string fragShaderStr = readFile("./OpenGLTemplate/src/Chapter2/Prog2_6_animation/fragShader.glsl");
