...
GLuint Utils::createShaderProgram() {
	...
	string vertShaderStr = readFile("./OpenGLTemplate/src/Chapter2/Prog2_5_triangle/vertShader.glsl");
	string fragShaderStr = readFile("./OpenGLTemplate/src/Chapter2/Prog2_5_triangle/fragShader.glsl");
