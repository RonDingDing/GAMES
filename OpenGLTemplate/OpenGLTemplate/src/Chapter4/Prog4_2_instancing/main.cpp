...
void init(GLFWwindow* window) {
	renderingProgram = Utils::createShaderProgram("./OpenGLTemplate/src/Chapter4/Prog4_2_instancing/vertShader.glsl", "./OpenGLTemplate/src/Chapter4/Prog4_2_instancing/fragShader.glsl");
