...
void init(GLFWwindow* window) {
	renderingProgram = Utils::createShaderProgram("./OpenGLTemplate/src/Chapter4/Prog4_1_4_multipleCubes/vertShader.glsl", "./OpenGLTemplate/src/Chapter4/Prog4_1_4_multipleCubes/fragShader.glsl");
...
void display(GLFWwindow* window, double currentTime) {
	...
	for (displayLoopi = 0; displayLoopi < 24; displayLoopi++) {
		tf = currentTime + (double)displayLoopi;
