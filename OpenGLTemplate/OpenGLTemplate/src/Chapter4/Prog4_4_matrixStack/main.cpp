...
void init(GLFWwindow* window) {
	renderingProgram = Utils::createShaderProgram("./OpenGLTemplate/src/Chapter4/Prog4_4_matrixStack/vertShader.glsl", "./OpenGLTemplate/src/Chapter4/Prog4_4_matrixStack/fragShader.glsl");
...
void display(GLFWwindow* window, double currentTime) {
	...
	mvStack.push(mvStack.top());
	mvStack.top() *= glm::rotate(glm::mat4(1.0f), (float)currentTime, glm::vec3(1.0, 0.0, 0.0)); // 太阳旋转
