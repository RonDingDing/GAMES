    ...
    bool TGA::Load(const std::string &Filename)
    {
        ...
        case 1:    // Uncompressed paletted
        {
            if (Head.Bits == 8)
            {
                ...
                {
                case 3:
                    RGBPaletted((uint8_t *)Buffer, ColorMap, Data, Head.Width * Head.Height);
                    break;
                case 4:
                    RGBAPaletted((uint8_t *)Buffer, ColorMap, Data, Head.Width * Head.Height);
                    break;
                }
            }
            else if (Head.Bits == 16)
            {
                ...
                {
                case 3:
                    RGBPaletted((uint16_t *)Buffer, ColorMap, Data, Head.Width * Head.Height);
                    break;
                case 4:
                    RGBAPaletted((uint16_t *)Buffer, ColorMap, Data, Head.Width * Head.Height);
                    break;
                }
            }
